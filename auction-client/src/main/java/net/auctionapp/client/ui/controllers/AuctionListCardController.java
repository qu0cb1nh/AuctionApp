...
public final class AuctionListCardController {
    private static final String FALLBACK_IMAGE =
            "/net/auctionapp/client/ui/images/iphone.jpg";
    ...
    private void setImage(String imageUrl) {
        ...
        Image fallback = new Image(getClass().getResource(FALLBACK_IMAGE).toExternalForm(), true);
