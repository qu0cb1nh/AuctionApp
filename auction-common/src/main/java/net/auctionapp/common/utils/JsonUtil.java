    ...
    public static Message fromJson(String json) {
        try {
            ...
            return switch (type) {
                ...
                case ADMIN_UPDATE_AUCTION_REQUEST -> GSON.fromJson(json, AdminUpdateAuctionRequestMessage.class);
                case ADMIN_DELETE_AUCTION_REQUEST -> GSON.fromJson(json, AdminDeleteAuctionRequestMessage.class);
                case ADMIN_FORCE_CLOSE_AUCTION_REQUEST -> GSON.fromJson(json, AdminForceCloseAuctionRequestMessage.class);
                case ADMIN_RESET_AUCTION_REQUEST -> GSON.fromJson(json, AdminResetAuctionRequestMessage.class);
